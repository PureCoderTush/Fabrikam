...
var onAboutUs=function(req, res){
    res.send("Institute Of Emerging Technology");
};
var onDefault=function(req, res){
    res.send("<h1>------Group Number 10-------</h1>"+
              "<hr/>"+
              "<ol>"+
                    " <li>Chair Person            : Amey Joshi</li>"+
                    " <li>Managing Director       : Naman Saxena</li>"+
                    " <li>Chief Executive Officer : Prajkta Mutyalwar</li>"+
                    " <li>Chief Financial Officer : Mahesh Shinde </li>"+
                    " <li>Chief Marketing Officer : Swapnil Kalange</li>"+
                    " <li>Chief Operating Officer : Tushar Sthul</li>"+
             "</ol>");
};
